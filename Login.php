...
<head>
 ...
 <style>
    .bank1-image {
  background-image: linear-gradient(rgba(0, 0, 0, 0.5), rgba(0, 0, 0, 0.5)), url("images/hb2.jpg");
  height: 700px;
...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
  ...
  <h3 class="text-center text-white pt-5"><b>CREATE NEW USER</b></h3>
        <br>
    ...
    <div class="screen">
      ...
      <div class="screen-body">
        <div class="screen-body-item left">
          <img class="img-fluid" src="images/hb3.jpg" style="border: none; border-radius: 50%;">
        </div>
